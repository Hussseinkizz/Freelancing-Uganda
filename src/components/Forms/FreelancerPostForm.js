...
const FreelancerPostForm = () => {
  ...
  return (
    <form>
      {/* form to help user post new freelancer open to work */}
      <div className="field">
      ...
      <FileUpload fileTitle="Your Photo" inputManager={getUplaodedFile} />
      ...
      <div className="field">
        ...
        <div className="control">
          <textarea
            className="textarea"
            placeholder="Give some brief information about your services..."
          ></textarea>
        </div>
      </div>
